-- @noindex
-- =======================================================================================
-- REFLEX THEME DEFAULT v1.9
-- =======================================================================================
-- Copy this file to Reflex_Theme.lua to customize Reflex's appearance and
-- track color overrides. Reflex_Theme.lua is optional and is not installed by
-- the ReaPack package.
--
...
--   These override the color shown on Reflex buttons, not in REAPER.
...
return {
  ...
  -- FONTS
  -- =====================================================
  -- Base UI text size. Reflex pre-creates scaled fonts
  ...
  -- COLORS
  -- =====================================================
  -- Override any Reflex UI color. Delete or comment out
